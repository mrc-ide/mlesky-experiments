...
ggarrange(t200_const_models_err[[1]]+config_rem_ax1, t50_const_models_err[[1]]+config_rem_ax1, t20_const_models_err[[1]]+config_rem_ax2, nrow=3, ncol=1, labels=c("n=200","n=50","n=20"), hjust=c(-0.8,-1,-1), font.label=list(size=12), legend="none")
ggsave("error_plots/comp_models/mae/const_models.pdf", units="in", width=7, height=7.5, dpi=600)

ggarrange(t200_const_models_err[[2]]+config_rem_ax1, t50_const_models_err[[2]]+config_rem_ax1, t20_const_models_err[[2]]+config_rem_ax2, nrow=3, ncol=1, labels=c("n=200","n=50","n=20"), hjust=c(-0.8,-1,-1), font.label=list(size=12), legend="none")
ggsave("error_plots/comp_models/rmse/const_models.pdf", units="in", width=7, height=7.5, dpi=600)
...
ggarrange(tx_const_skykappa_err[[1]]+config_rem_ax1, tx_const_skygrid_err[[1]]+config_rem_ax1, tx_const_skygrowth_err[[1]]+config_rem_ax2, nrow=3, ncol=1, labels=c("Skykappa","Skygrid","Skygrowth"), hjust=c(-0.5,-0.65,-0.45), font.label=list(size=12), legend="none")
ggsave("error_plots/comp_models/mae/const_diff_samp_sizes.pdf", units="in", width=7, height=7.5, dpi=600)

ggarrange(tx_const_skykappa_err[[2]]+config_rem_ax1, tx_const_skygrid_err[[2]]+config_rem_ax1, tx_const_skygrowth_err[[2]]+config_rem_ax2, nrow=3, ncol=1, labels=c("Skykappa","Skygrid","Skygrowth"), hjust=c(-0.5,-0.65,-0.45), font.label=list(size=12), legend="none")
ggsave("error_plots/comp_models/rmse/const_diff_samp_sizes.pdf", units="in", width=7, height=7.5, dpi=600)
