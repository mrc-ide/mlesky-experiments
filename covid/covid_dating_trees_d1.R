...
# make treedater trees 
tds_list = date_trees(mltr_fn = "Sample_England_2021-02-03_n_5000_nreps_10.nwk",
                              ofn = paste0('Sample_England_2021-02-03_n_5000_nreps_10_n_tree_dating_10'), 
                              metadata = metadata, 
                              meanrate = mr,
                              n_tree_dating = 10,
                              meanratesd = mrsd, 
